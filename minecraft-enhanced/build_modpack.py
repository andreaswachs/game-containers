...
MODS = [
    ...
    ("5sy6g3kz", VERSIONS["BETTER_COMBAT_MODRINTH_ID"], "bettercombat-fabric-2.4.0+1.21.1.jar",
     ...
     "required", "required"),
    # Vehicles
    ("x3HZvrj6", VERSIONS["IMMERSIVE_AIRCRAFT_MODRINTH_ID"], "immersive_aircraft-1.5.2+1.21.1-fabric.jar",
     "https://cdn.modrinth.com/data/x3HZvrj6/versions/" + VERSIONS["IMMERSIVE_AIRCRAFT_MODRINTH_ID"] + "/immersive_aircraft-1.5.2%2B1.21.1-fabric.jar",
     "required", "required"),
    ("9qdTHi0q", VERSIONS["MAN_OF_MANY_PLANES_MODRINTH_ID"], "man_of_many_planes-0.2.2+1.21.1-fabric.jar",
     "https://cdn.modrinth.com/data/9qdTHi0q/versions/" + VERSIONS["MAN_OF_MANY_PLANES_MODRINTH_ID"] + "/man_of_many_planes-0.2.2%2B1.21.1-fabric.jar",
     "required", "required"),
    # Magic
    ...
    ("fQEb0iXm", VERSIONS["KRYPTON_MODRINTH_ID"], "krypton-0.2.8.jar",
     ...
     "required", "required"),
    ("nmDcB62a", VERSIONS["MODERNFIX_MODRINTH_ID"], "modernfix-fabric-5.25.1+mc1.21.1.jar",
     "https://cdn.modrinth.com/data/nmDcB62a/versions/" + VERSIONS["MODERNFIX_MODRINTH_ID"] + "/modernfix-fabric-5.25.1%2Bmc1.21.1.jar",
     "required", "required"),
    ...
    ("NNAgCjsB", VERSIONS["ENTITY_CULLING_MODRINTH_ID"], "entityculling-fabric-1.10.5-mc1.21.1.jar",
     ...
     "required", "unsupported"),
    ("5ZwdcRci", VERSIONS["IMMEDIATELYFAST_MODRINTH_ID"], "ImmediatelyFast-Fabric-1.6.14+1.21.1.jar",
     "https://cdn.modrinth.com/data/5ZwdcRci/versions/" + VERSIONS["IMMEDIATELYFAST_MODRINTH_ID"] + "/ImmediatelyFast-Fabric-1.6.14%2B1.21.1.jar",
     "required", "unsupported"),
    ("51shyZVL", VERSIONS["MORE_CULLING_MODRINTH_ID"], "moreculling-fabric-1.21.1-1.0.10.jar",
     "https://cdn.modrinth.com/data/51shyZVL/versions/" + VERSIONS["MORE_CULLING_MODRINTH_ID"] + "/moreculling-fabric-1.21.1-1.0.10.jar",
     "required", "unsupported"),
    ("LQ3K71Q1", VERSIONS["DYNAMIC_FPS_MODRINTH_ID"], "dynamic-fps-3.11.4+minecraft-1.21.0-fabric.jar",
     "https://cdn.modrinth.com/data/LQ3K71Q1/versions/" + VERSIONS["DYNAMIC_FPS_MODRINTH_ID"] + "/dynamic-fps-3.11.4%2Bminecraft-1.21.0-fabric.jar",
     "required", "unsupported"),
    ("g96Z4WVZ", VERSIONS["BADOPTIMIZATIONS_MODRINTH_ID"], "BadOptimizations-2.4.1-1.21.1.jar",
     "https://cdn.modrinth.com/data/g96Z4WVZ/versions/" + VERSIONS["BADOPTIMIZATIONS_MODRINTH_ID"] + "/BadOptimizations-2.4.1-1.21.1.jar",
     "required", "unsupported"),
    ("OVuFYfre", VERSIONS["ENHANCED_BLOCK_ENTITIES_MODRINTH_ID"], "enhancedblockentities-0.10.2+1.21.jar",
     "https://cdn.modrinth.com/data/OVuFYfre/versions/" + VERSIONS["ENHANCED_BLOCK_ENTITIES_MODRINTH_ID"] + "/enhancedblockentities-0.10.2%2B1.21.jar",
     "required", "unsupported"),
    # Performance (server only)
    ("vE2FN5qn", VERSIONS["LET_ME_DESPAWN_MODRINTH_ID"], "letmedespawn-1.21.x-fabric-1.5.0.jar",
     "https://cdn.modrinth.com/data/vE2FN5qn/versions/" + VERSIONS["LET_ME_DESPAWN_MODRINTH_ID"] + "/letmedespawn-1.21.x-fabric-1.5.0.jar",
     "unsupported", "required"),
    ("Gi02250Z", VERSIONS["ALMANAC_MODRINTH_ID"], "Almanac-1.21.1-2-fabric-1.5.2.jar",
     "https://cdn.modrinth.com/data/Gi02250Z/versions/" + VERSIONS["ALMANAC_MODRINTH_ID"] + "/Almanac-1.21.1-2-fabric-1.5.2.jar",
     "unsupported", "required"),
    # Libraries
